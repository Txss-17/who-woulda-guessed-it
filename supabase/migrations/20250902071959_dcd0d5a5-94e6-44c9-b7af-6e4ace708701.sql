...
-- Améliorer la table round_votes avec des contraintes appropriées
ALTER TABLE public.round_votes 
ADD CONSTRAINT unique_vote_per_question_per_voter 
...
CREATE INDEX idx_round_votes_game_question ON public.round_votes(game_id, question_index);
