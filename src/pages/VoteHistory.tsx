...
import VoteHistoryExport from "@/components/vote-history/VoteHistoryExport";
...
const VoteHistory = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20 py-6 px-4">
      <div className="container mx-auto max-w-4xl" id="vote-history-container">
        <VoteHistoryHeader 
          playerCount={gameData.playerCount} 
          date={gameData.date} 
        />
        
        <VoteHistoryExport gameData={gameData} />
